...
<body>
	...
	<?php if ( !$user_id ): ?>
		<fb:login-button onlogin="window.location='/fbdemo'"></fb:login-button>
	<?php else: ?>
		<img class="profile_square" src="<?=$user['pic_square']?>" />
		Hi <?=$user['first_name']?>!<br />
		<a href="#" onclick="FB.Connect.logout(function() { window.location='<?=$current_page?>' }); return false;" >(Logout)</a>
	<?php endif; ?>
