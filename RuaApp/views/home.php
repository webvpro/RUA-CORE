<body>
	...
	<header> <!-- Defining the header section of the page with the appropriate tag -->
		...
		<div id="search"> <input type="text" id="s" name="s" onclick="this.value='';" value="Site Search" /> <input type="image" class="btn" id="searchsubmit" value="Search" src="/theme/all/images/search.jpg" name="" /></div></div>
	</header>
<!-- Article 1 start -->
